...
use crate::types::{VerifiedGatewayAttestation, VerifyGatewayAttestationInput};
...
pub async fn verify_gateway_attestation(
    input: VerifyGatewayAttestationInput<'_>,
    ...
    let verified_quote = verify_dstack_quote(
        ...
        Some(&input.attestation.reported_quote_data),
    )
    .await?;
