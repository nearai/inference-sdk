...
`0.1.0-rc.4`; Python and Rust remain at `0.1.0`. Python and Rust imports use
...
| Registry | Artifact |
| --- | --- |
| npm | `dist/nearai-inference-sdk-0.1.0-rc.4.tgz` |
...
```sh
npm publish ./dist/nearai-inference-sdk-0.1.0-rc.4.tgz --tag next --access public --registry https://registry.npmjs.org/
```

Install the candidate with `npm install @nearai/inference-sdk@next`, or pin
`@nearai/inference-sdk@0.1.0-rc.4`. Use `0.1.0-rc.5` for a subsequent candidate.
...
tag the released commit `npm-v0.1.0-rc.4` after publication and installation
